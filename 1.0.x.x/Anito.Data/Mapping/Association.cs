...
namespace Anito.Data.Mapping
{
    ...
    {      
        ...
        public RelationHierarchy Hierarchy { get; set; }

        public Association(Relation relation, RelationHierarchy hierarchy, string member, string sourceKey, string referenceKey, bool viewOnly)
        {
