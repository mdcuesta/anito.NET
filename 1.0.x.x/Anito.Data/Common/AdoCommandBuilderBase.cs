...
namespace Anito.Data.Common
{
    public abstract class AdoCommandBuilderBase : ICommandBuilder
    {
        ...
        public abstract ICommand CreateGetChildrenCommand<T>(TypeRelation relation, params object[] referenceValue);

        public abstract ICommand CreateExecuteScalarCommand<T>(Expression column, Expression expression);
        #endregion
