...
namespace Anito.Data
{
    public interface ICommandBuilder
    {
        ...
        ICommand CreateGetChildrenCommand<T>(TypeRelation relation, params object[] referenceValue);
        ...
        //Execute
        ICommand CreateExecuteScalarCommand<T>(Expression column, Expression expression);
